...
quill.use(require('maki-client-traverse'));
quill.use(require('maki-client-markdown'));
quill.use(require('maki-client-moment'));
quill.use(require('maki-client-remote'));
quill.use(require('maki-client-search'));
...
var Index = quill.define('Index', {
  ...
  documentation: 'Quill will automatically convert any pasted content to Markdown for storage.',
  components: {
...
var Draft = quill.define('Draft', {
  public: false,
  icon: 'file text',
  description: 'Written content by an author.',
  components: {
    query: 'quill-workspace',
    get: 'quill-post-viewer'
  },
  attributes: {
    id: { type: String , id: true },
    author: { type: String , ref: 'Author' },
